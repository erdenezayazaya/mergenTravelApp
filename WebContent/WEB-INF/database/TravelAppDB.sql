...
CREATE TABLE `comments` (
  ...
  CONSTRAINT `idposts` FOREIGN KEY (`idposts`) REFERENCES `posts` (`idposts`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `posts` (
  ...
  `idusers` int(11) DEFAULT NULL,
  `idcomments` int(11) DEFAULT NULL,
  ...
  KEY `comment_idx` (`idcomments`),
  CONSTRAINT `comment` FOREIGN KEY (`idcomments`) REFERENCES `comments` (`idcomments`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `user` FOREIGN KEY (`idusers`) REFERENCES `users` (`idusers`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2017-05-23  0:54:52
