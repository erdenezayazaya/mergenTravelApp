<form action="Register" method="POST" class="form-signin" role="form">
   <h3 class="form-signin-heading text-center">Registration</h3>
...
<div class="row">
  ...
  <div class="col-sm-6">
    	<select id="birthYear" name="birthYear" class="form-control" required>
...
<div class="row">
  ...
  <div class="col-sm-6">
    	    <input type="password" class="form-control" name="loginPass" id="loginPass" placeholder="Password" pattern="(?=^.{6,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$"
	title="Must contain at least 6 letters and have at least one capital letter, one small letter, one number" required>
  </div>
</div>
